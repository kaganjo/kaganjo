...
$wambua_corrupted_employees ="NAME,JOB TITLE,DEPARTMENT,FULL OR PART-TIME,SALARY OR HOURLY,TYPICAL HOURS,ANNUAL SALARY,HOURLY RATE
...
//echo clean($wambua_corrupted_employees);

//echo $wambua_corrupted_employees;

$wc_array = explode(',',$wambua_corrupted_employees);
$column_number = 8;
?>

<table border="1" cellspacing="0" cellpadding="2">
<thead>
<?php $row_num = count($wc_array)/ 8; $counter=0;?>
<?php for($i =0; $i<$row_num; $i++):  ?>
  <tr>
  <?php for($j= 0;$j<8;$j++):?>
    <th><?php echo clean($wc_array[$counter]); ?></th>
    <?php $counter++; endfor; ?>
  </tr>
<?php endfor; ?>
</thead>
